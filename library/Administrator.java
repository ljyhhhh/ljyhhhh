...
public class Administrator {
    ...
    //放入书
    public void addBooks(Book book,int shelfnumber){
        bookshelves[shelfnumber-1].books.add(book);
        book.m(shelfnumber);
    }
    //下架书
    public void deleteBooks(Book book,int shelfnumber) {
    ...
    public void addUserToBlacklist(User a,Administrator ad){
        userblacklist.add(a);
        while(!a.booklist.isEmpty()){
            a.returnBooks(a.booklist.get(0),ad);
        }
    }
